...
Ã¢â‚¬Æ’Ã¢â‚¬Æ’$.datepicker.regional[''''it''''] = {
Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’closeText: ''''Chiudi'''',
Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’prevText: ''''&#x3c;Prec'''',
Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’nextText: ''''Succ&#x3e;'''',
Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’currentText: ''''Oggi'''',
Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’monthNames: [''''Gennaio'''',''''Febbraio'''',''''Marzo'''',''''Aprile'''',''''Maggio'''',''''Giugno'''',
Ã¢â‚¬Æ’Ã¢â‚¬Æ’''''Luglio'''',''''Agosto'''',''''Settembre'''',''''Ottobre'''',''''Novembre'''',''''Dicembre''''],
Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’monthNamesShort:  [''''Gen'''',''''Feb'''',''''Mar'''',''''Apr'''',''''Mag'''',''''Giu'''',
Ã¢â‚¬Æ’Ã¢â‚¬Æ’''''Lug'''',''''Ago'''',''''Set'''',''''Ott'''',''''Nov'''',''''Dic''''],
Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’dayNames: [''''Domenica'''',''''Luned&#236'''',''''Marted&#236'''',''''Mercoled&#236'''',''''Gioved&#236'''',''''Venerd&#236'''',''''Sabato''''],
Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’dayNamesShort: [''''Dom'''',''''Lun'''',''''Mar'''',''''Mer'''',''''Gio'''',''''Ven'''',''''Sab''''],
Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’dayNamesMin: [''''Do'''',''''Lu'''',''''Ma'''',''''Me'''',''''Gi'''',''''Ve'''',''''Sa''''],
Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’weekHeader: ''''Sm'''',
Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’dateFormat: ''''dd/mm/yy'''',
Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’firstDay: 1,
Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’isRTL: false,
Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’showMonthAfterYear: false,
Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’yearSuffix: ''''''''};
Ã¢â‚¬Æ’});

Ã¢â‚¬Æ’jQuery(function($) {
Ã¢â‚¬Æ’Ã¢â‚¬Æ’if (Modernizr.touch && Modernizr.inputtypes.date) {
Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’$.each(Ã¢â‚¬Æ’$(\"input.userprofile-date\"), function(index, item) {
Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’item.type = ''''date'''';
Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’});
Ã¢â‚¬Æ’Ã¢â‚¬Æ’} else {
Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’$.datepicker.setDefaults( $.datepicker.regional[ \"${currentLangVar}\" ] );
Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’$(\"input.userprofile-date\").datepicker({
Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’changeMonth: true,
Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’changeYear: true,
Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’dateFormat: \"dd/mm/yy\"
Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’Ã¢â‚¬Æ’});
Ã¢â‚¬Æ’Ã¢â‚¬Æ’}
Ã¢â‚¬Æ’});
Ã¢â‚¬Æ’">
...
<#if isClosed >
â€ƒ<#assign opencloseActionUrl><@wp.info key="systemParam" paramName="applicationBaseURL" />do/jpmyportalplus/front/openFrame.action?frameToResize=${currentFrameVar}&currentPageCode=<@wp.currentPage param="code" /></#assign>
<#else>â€ƒ
â€ƒ<#assign opencloseActionUrl><@wp.info key="systemParam" paramName="applicationBaseURL" />do/jpmyportalplus/front/closeFrame.action?frameToResize=${currentFrameVar}&currentPageCode=<@wp.currentPage param="code" /></#assign>
</#if>

<#if isEditFormOpen >
â€ƒ<@c.set var="editFrameValue" value=null />
<#else>â€ƒ
â€ƒ<@c.set var="editFrameValue">${currentFrameVar}</@c.set>
</#if>
...
â€ƒ<div class="widget-toolbar btn-group pull-left">
â€ƒâ€ƒ<a href="${removeActionUrl}" class="btn btn-mini btn-danger button-toggler-remove" title="remove"><i class="icon-remove"></i><span class="sr-only">x</span></a>&#32;
â€ƒâ€ƒ<a href="${moveActionUrl}" class="btn btn-mini btn-info button-toggler-edit" title="configure/options"><i class="icon-cog"></i><span class="sr-only">configure/options</span></a>
â€ƒâ€ƒ<a href="${opencloseActionUrl}" class="btn btn-mini btn-info button-toggler-open-close" title="toggle open close"><i class="icon-chevron-<#if isClosed >down<#else>up</#if>"></i><span class="sr-only">open/close</span></a>&#32;
â€ƒ</div>
â€ƒ<div class="widget-draggable">
â€ƒâ€ƒ<h1 class="pull-right">
  <#if RequestParameters.search?? ><#assign showletTitle ><@c.out value="${showletTitle}" escapeXml=false /></#assign></#if>
â€ƒâ€ƒ<#if showletTitle?? >
â€ƒâ€ƒâ€ƒ${showletTitle}
â€ƒâ€ƒ<#else>
â€ƒâ€ƒâ€ƒ<@wp.currentWidget param="title" />
â€ƒâ€ƒ</#if>
â€ƒâ€ƒ</h1>
â€ƒ</div>
â€ƒ
â€ƒ<div class="clearfix"></div>
â€ƒ<div class="editContentBox <#if !isEditFormOpen >hide</#if>"></div>
â€ƒ<div class="clearfix widget-border-bottom"></div>
â€ƒ<div class="widget-body margin-medium-all padding-medium-bottom <#if isClosed >hide</#if>">', 1);
